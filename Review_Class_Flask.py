...
def parse_args():
    ...
    parser.add_argument('--data_file', type=str, required=True, help="Path to the CSV file containing texts.")
    parser.add_argument('--output_file', type=str, required=True, help="Path to the CSV file containing texts and labels.")
