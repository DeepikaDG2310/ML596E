...
from App_dangerrousness import BERTClassifier, TextClassificationDataset, predict_sentiment # Import your BERTClassifier class
...
def predict():
    ...
    return jsonify({
        'File_name': file_name,
        'predicted_class_file': predicted_class
    })
